        ...
        <div class="ms-5 collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="container d-flex justify-content-lg-end justify-content-sm-center justify-content-md-center">
                ...
                <a class="icon-link p-3" href="">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-circle" width="28"
                ...
                <a class="icon-link p-3" href="views/user/inicio_sesion.jsp">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-shopping-cart" width="28"
                         height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round"
                         stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <div class="row">
                        <article class="col-12 col-lg-7">
                            ...
                            <a href="./views/user/registro_usuarios.jsp" class="text-decoration-none text-dark link-animation"
                               style=" font-weight: 700; color:black"><button class="btn btn-dark m-4"
                                                                              style="font-weight: 300; border-radius: 0; padding: 10px; width: 150px;">Regístrate</button>
                            </a>
                        </article>
                        <article class="col-12 col-lg-5 ps-lg-5 ps-sm-0">
                            <img src="./assets/img/e9be2a1f1471feb0c1b18083309ea295.jpg" alt="img-hilos" class="img-fluid">
                        </article>
                    </div>
                </section>
            </div>
        ...
        <div class="container-fluid pb-5">
            <div class="container mt-5">
                ...
                >Desde suaves algodones hasta lujosas
                    ...
                    la comodidad y la creatividad en cada fibra, y deja que tus proyectos tejidos cuenten historias únicas en
                    cada puntada</p>
            </div>
            ...
            <div class="container pt-5 mt-5" style="font-family: 'Raleway', sans-serif; font-weight: 500;">
                <div class="row justify-content-evenly">
                    <div class="col-12 col-lg-5">
                        <div class="circle">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-droplet" width="28"
                                 height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round"
                                 stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path
                        ...
                        <div class="container text-center">
                            <p class="fs-lg-5">Nuestra tienda te brinda una experiencia refrescante y revitalizante. Al igual que el
                                agua que sacia tu
                                sed,
                                ofrecemos productos que satisfacen tus necesidades y te ayudan a dar vida a tus proyectos.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="circle">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-sun" width="28" height="28"
                                 viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round"
                                 stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <div class="container text-center">
                            <p class="fs-lg-5">
                                En nuestra tienda, encontrarás productos que brillan con calidad y excelencia. Así como el sol irradia
                                luz y calidez, nosotros iluminamos tu experiencia de compra con tejidos de alta calidad y una atención
                                dedicada.
                            </p>
                        </div>
                    </div>
                    <div class="col-12 col-lg-5">
                        <div class="circle">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-heart-handshake" width="28"
                                 height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round"
                                 stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <div class="container text-center">
                            <p class="fs-lg-5">
                                Nos enorgullece ser una tienda accesible para todos. Al igual que el sol brinda su luz a todos por
                    ...
                    <div class="container pt-5 mt-5">
                        <div class="row justify-content-evenly">
                            ...
                            <div class="col-12 col-lg-4 ps-5 mt-5">
                                <p class="fs-lg-5">¡Bienvenido a Manos Mexicanas! Aquí encontrarás mucho más que simples tejidos. Nos
                                    enorgullece
                                    ofrecerte una experiencia completa donde podrás explorar un mundo de posibilidades creativas.
                                    <br><br>
                                    Nuestra tienda se destaca por brindarte: <br>
                                <ul style="list-style: number;">
                                    <li>Una selección excepcional: Nos dedicamos a ofrecerte una amplia variedad de tejidos de alta
                                        calidad,
                                        cuidadosamente elegidos para satisfacer tus necesidades y superar tus expectativas.</li>

                                    <li>Inspiración ilimitada: Queremos ser tu fuente de inspiración. Por eso, te ofrecemos una amplia
                                        gama
                                        de productos y servicios para que puedas dar vida a tus ideas y proyectos.</li>

                                    <li>Atención personalizada: Valoramos a cada cliente y nos esforzamos por brindarte un servicio
                                        excepcional.</li>
                                </ul>
                                <button class="btn btn-dark m-4"
                                        style="font-weight: 300; border-radius: 0; padding: 10px; width: 150px;">Ver más</button>
    ...
    <section>
        <div class="container-fluid p-5" style="background-color: #f0f1ee;">
            <div class="container">
                ...
                <p class="lead text-center fw-medium fs-5 mb-5">Dejate cautivar por los artículos que han sido tendencia esta
                    semana</p>
            </div>
            <div class="container">
