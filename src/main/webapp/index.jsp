            ...
            <div class="row">
                <article class="col-12 col-lg-7">
                    ...
                    <button class="btn btn-dark m-4"
                            style="font-weight: 300; border-radius: 0; padding: 10px; width: 150px;"><a href="/user/register-view" style="text-decoration: none; color: whitesmoke;">Regístrate</a></button>
