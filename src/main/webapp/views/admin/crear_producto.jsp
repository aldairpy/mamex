    ...
    <div class="offcanvas-body">
        <div class="sidebar">
            <ul class="list-unstyled p-5 mt-5" style="font-size: 14px;">
                <li class="mb-3"><a href="./inicio.jsp" class="nav-link"><i data-feather="home"></i><span class="ps-3">Inicio</span></a>
                </li>
                <li class="mb-3"><a href="" class="nav-link"><i data-feather="shopping-cart"></i><span class="ps-3">Órdenes</span></a>
                </li>
                <li class="mb-3"><a href="./products.jsp" class="nav-link"><i data-feather="tag"></i><span class="ps-3">Productos</span></a>
                </li>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table caption-top">
                            ...
                            <tbody>
                            <tr>
                                <th><img src="${pageContext.request.contextPath}/assets/img/OIP.jpg" alt="product-img" height="100" width="100"></th>
                                <td>4.7 MB</td>
                                <td><input class="form-check-input ms-1" type="checkbox" value=""
