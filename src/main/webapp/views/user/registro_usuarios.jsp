    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7 col-12 mt-lg-4 mt-md-5 mt-xs-1">
                ...
                <div class="container">
                    <form action="" class="text-center w-50 m-auto fs-1 pt-3">
                        <div class="m-4">
                            <input class="form-control" type="text" id="name" placeholder="Nombre(s)" required>
                        </div>
                        <div class="m-4">
                            <input class="form-control" type="text" id="surname" placeholder="Apellidos" required>
                        </div>
                        <div class="m-4">
